...
import com.saic.ebiz.wechat.authorization.JsapiTicket;
import com.saic.ebiz.wechat.authorization.SaicX509TrustManager;
import com.saic.ebiz.wechat.authorization.Token;
import com.saic.ebiz.wechat.constants.Constants;
...
//          SSLContext sslContext = SSLContext.getInstance("SSL", "SunJSSE");
    ...
    public static Token getAccessToken(String appid, String appsecret) {
        ...
        String requestUrl = PropertiesUtil.TOKEN_URL.replace("APPID", appid).replace("APPSECRET", appsecret);
        ...
        if(accessToken == null) {
            try {
                Thread.sleep(Constants.THREAD_SLEEP_5_SECONDS);
    ...
    public static JsapiTicket getJsapiTicket(Token accessToken){
		...
		String requestUrl = PropertiesUtil.TICKET_URL.replace("ACCESS_TOKEN", accessToken.getToken());
