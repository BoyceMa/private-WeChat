...
public class AuthorizationService {
	...
	private static String userinfo_url = PropertiesUtil.HTTPS_SNS_USER_INFO;
	 ...
	 * @since [产品/模块版本](可选)
	 */
	public Map<String,String> getSdkSignMap(HttpServletRequest request) {
		Map<String, String> map = null;
		if(request.getQueryString() == null ){
			map = jsSDKSign.sign(appId, request.getRequestURL().toString());
		}else{
			map = jsSDKSign.sign(appId, request.getRequestURL().toString() + "?" + request.getQueryString());
		}
